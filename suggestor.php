                ...
                <div id="step-1" class="step-container transition-all duration-500 animate-in fade-in slide-in-from-right-10">
                    ...
                    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-8">
                        <label class="relative cursor-pointer group rounded-[2rem] overflow-hidden shadow-md hover:shadow-2xl transition-all duration-500 block h-48 md:h-56 transform hover:-translate-y-1">
                            ...
                            <img width="800" height="600" src="images/uploads/daulatabad.png" alt="Historic Places" class="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-110">
                        ...
                        <label class="relative cursor-pointer group rounded-[2rem] overflow-hidden shadow-md hover:shadow-2xl transition-all duration-500 block h-48 md:h-56 transform hover:-translate-y-1">
                            ...
                            <img width="800" height="600" src="images/uploads/grishneshwar.png" alt="Mandir & Temples" class="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-110">
                            <div class="absolute inset-0 bg-gradient-to-t from-slate-900/90 via-slate-900/40 to-transparent peer-checked:via-primary/50 transition-colors duration-300"></div>
                            <div class="absolute inset-0 border-[3px] border-transparent peer-checked:border-primary rounded-[2rem] transition-colors shadow-[inset_0_0_0_1px_rgba(255,255,255,0.2)]"></div>
                            <div class="absolute top-4 right-4 opacity-0 peer-checked:opacity-100 transition-opacity z-10 bg-white/20 backdrop-blur-md rounded-full shadow-lg">
                                <span class="material-symbols-outlined text-white text-2xl drop-shadow-md p-1">check_circle</span>
                        ...
                        <label class="relative cursor-pointer group rounded-[2rem] overflow-hidden shadow-md hover:shadow-2xl transition-all duration-500 block h-48 md:h-56 transform hover:-translate-y-1">
                            ...
                            <img width="800" height="600" src="images/uploads/ellora.png" alt="Nature & Caves" class="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-110">
                            <div class="absolute inset-0 bg-gradient-to-t from-slate-900/90 via-slate-900/40 to-transparent peer-checked:via-primary/50 transition-colors duration-300"></div>
                            <div class="absolute inset-0 border-[3px] border-transparent peer-checked:border-primary rounded-[2rem] transition-colors shadow-[inset_0_0_0_1px_rgba(255,255,255,0.2)]"></div>
                            <div class="absolute top-4 right-4 opacity-0 peer-checked:opacity-100 transition-opacity z-10 bg-white/20 backdrop-blur-md rounded-full shadow-lg">
                                <span class="material-symbols-outlined text-white text-2xl drop-shadow-md p-1">check_circle</span>
                        ...
                        <label class="relative cursor-pointer group rounded-[2rem] overflow-hidden shadow-md hover:shadow-2xl transition-all duration-500 block h-48 md:h-56 transform hover:-translate-y-1">
                            ...
                            <img width="800" height="600" src="images/uploads/indian-thali.jpg" alt="Local Cuisine" class="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-110">
                            <div class="absolute inset-0 bg-gradient-to-t from-slate-900/90 via-slate-900/40 to-transparent peer-checked:via-primary/50 transition-colors duration-300"></div>
                            <div class="absolute inset-0 border-[3px] border-transparent peer-checked:border-primary rounded-[2rem] transition-colors shadow-[inset_0_0_0_1px_rgba(255,255,255,0.2)]"></div>
                            <div class="absolute top-4 right-4 opacity-0 peer-checked:opacity-100 transition-opacity z-10 bg-white/20 backdrop-blur-md rounded-full shadow-lg">
                                <span class="material-symbols-outlined text-white text-2xl drop-shadow-md p-1">check_circle</span>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div data-reveal="right" class="relative h-[450px] w-full flex items-center justify-center" id="suggestor-stack-wrap">
                ...
                <div class="img-stack-card">
                    <img width="800" height="600" src="<?php echo BASE_PATH; ?>/images/uploads/ellora.png" alt="Ellora Caves" class="w-full h-full object-cover">
                ...
                <div class="img-stack-card">
                    ...
                    <img width="800" height="600" src="<?php echo BASE_PATH; ?>/images/uploads/ajanta.png" alt="Ajanta Caves" class="w-full h-full object-cover">
                    <div class="img-stack-overlay"></div>
                    <div class="img-stack-title">Ancient Ajanta</div>
                </div>
                <div class="img-stack-card">
                    <img width="800" height="600" src="<?php echo BASE_PATH; ?>/images/uploads/masala-dosa.jpg" alt="Local Cuisine" class="w-full h-full object-cover">
                    <div class="img-stack-overlay"></div>
                    <div class="img-stack-title">Exquisite Local Dining</div>
                </div>
                <div class="img-stack-card">
                    <img width="800" height="600" src="<?php echo BASE_PATH; ?>/images/uploads/daulatabad.png" alt="Daulatabad Fort" class="w-full h-full object-cover">
                    <div class="img-stack-overlay"></div>
