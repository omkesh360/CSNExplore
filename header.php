...
<head>
    ...
    <meta name="DC.coverage" content="Chhatrapati Sambhajinagar, Aurangabad, Maharashtra, India" />
    <meta name="DC.publisher" content="CSNExplore" />
    <!-- Extended OG Tags -->
    ...
    <script type="application/ld+json">
    {
      ...
      "@type": "WebSite",
      "name": "CSNExplore",
      "alternateName": ["csn explore", "csnxplore", "Aurangabad Tourism Portal", "Chhatrapati Sambhajinagar Travel"],
      "url": "https://csnexplore.com",
      "description": "CSNExplore is the #1 tourism portal for Chhatrapati Sambhajinagar (Aurangabad). Hotels, car rentals, bike rentals, Ajanta & Ellora Caves tours.",
      "potentialAction": {
        "@type": "SearchAction",
        "target": {
          "@type": "EntryPoint",
          "urlTemplate": "https://csnexplore.com/listing?type={search_term_string}"
        },
    ...
    // Enhanced SEO with dual city name optimization
    $itemName = $page_meta['item']['name'] ?? '';
    $enhancedKeywords = SEOOptimizer::generateKeywords($seo_type, $itemName);
    echo '<meta name="keywords" content="' . htmlspecialchars($enhancedKeywords) . '">' . "\n";
