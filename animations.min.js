...
(function () {
  ...
  // ── CRITICAL: Back/Forward Cache (bfcache) White Page Fix ────────────────
  // When user hits Back, browser restores page from bfcache instantly.
  // The pageshow event fires with e.persisted=true.
  // IntersectionObserver does NOT re-fire for already-in-viewport elements,
  // so [data-reveal] elements stay at opacity:0 → white/blank page.
  // Fix: immediately reveal everything and restore body on pageshow.
  window.addEventListener('pageshow', function(e) {
    // Always restore body visibility (guards against any opacity:0 state)
    document.body.style.transition = 'none';
    document.body.style.opacity = '1';
    document.body.style.visibility = 'visible';
    document.body.classList.remove('page-fade-out');

    // On bfcache restore, immediately reveal all hidden elements
    if (e.persisted) {
      document.querySelectorAll('[data-reveal],[data-reveal-children],[data-animate],.card-reveal').forEach(function(el) {
